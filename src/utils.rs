...
/// Plutonium is the struct containing all our necessary metadata.
#[repr(C)]
pub struct Plutonium {
...
/// Deserialize instruction_data into Plutonium struct.
...
/// Deserialize account data into Plutonium struct.
/// This is used for reading the metadata from the account holding the locked funds.
pub fn unpack_account_data(ix: &[u8]) -> Plutonium {
    Plutonium {
